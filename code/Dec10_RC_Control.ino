    ...
    // robot moving forward and in reverse using Hobby RC controller
      ...
      if (rc_values[RC_CH3] < 1300) reverse(map(rc_values[RC_CH3], 600, 1300, 0, 255));
      if ((rc_values[RC_CH3] < 1700) && (rc_values[RC_CH3] > 1300)) stop();
    
    // robot moving right and left using Hobby RC controller
    
      if (rc_values[RC_CH4] > 1700) right(map(rc_values[RC_CH4], 1700, 2500, 0, 255));
      if (rc_values[RC_CH4] < 1300) left (map(rc_values[RC_CH4], 600, 1300, 0, 255));
